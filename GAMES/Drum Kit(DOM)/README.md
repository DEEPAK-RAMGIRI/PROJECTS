...
### Tech Used:
 ...
 - HTML – for the structure of the web page and buttons.

 - CSS – for styling, fonts, and button animations.

 - JavaScript – for event handling, playing sounds, and dynamic animations.

 - DOM (Document Object Model) methods – like querySelectorAll and addEventListener to handle clicks and keypresses.

 - Audio API – new Audio() to play sound files.
